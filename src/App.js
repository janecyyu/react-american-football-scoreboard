    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          {/* TODO STEP 4 - Now we need to attach our state setter functions to click
          listeners. */}
          <button
            className="homeButtons__touchdown"
            onClick={() => setScoreL(scoreL + 7)}
          >
            Home Touchdown
          </button>
          <button
            className="homeButtons__fieldGoal"
            onClick={() => setScoreL(scoreL + 3)}
          >
            Home Field Goal
          </button>
        </div>
        <div className="awayButtons">
          <button
            ...
            onClick={() => setScoreT(scoreT + 7)}
          >
            Away Touchdown
          </button>
          <button
            className="awayButtons__fieldGoal"
            onClick={() => setScoreT(scoreT + 3)}
          >
            Away Field Goal
          </button>
        </div>
